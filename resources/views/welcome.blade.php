        ...
        <div class="row">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="well">
                                <p style="font-family: 'Telex',sans-serif;font-weight: bold;line-height: 1;color: #317eac;text-rendering: optimizelegibility;">
                                    Дія</p>
                                <button  id="kecske" class="btn btn-primary" title="Зберегти як зображення"><i style="font-size: 25px;"
                                                                                        class="fa fa-camera"
                                                                                        aria-hidden="true"></i></button>
                                <button id="rotate" title="Повернути" class="btn btn-primary"><i style="font-size: 25px;"
                                                                               class="fa fa-repeat"
                                                                               aria-hidden="true"></i></button>                                <button  class="btn btn-primary" title="Видалити все"><i style="font-size: 25px;"
                                                                               class="fa fa-trash"
                                                                               aria-hidden="true"></i></button>
            ...
            <div class="span6">
                ...
                <div id="shirtDiv" class="page"
                    ...
                    <img id="tshirtFacing" src="img/test.jpg"></img>
            ...
            <div class="span3">
                <div class="well">
                    ...
                    <button type="button" class="btn btn-large btn-block btn-success" name="addToTheBag"
                            id="addToTheBag">Додати в сумку <i class="icon-briefcase icon-white"></i></button>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#addimg").on('click', function () {
            $('#avatarlist').append('<img style="cursor:pointer;" class="img-polaroid tt" src="img/templates/1.png">');
        });
    });
